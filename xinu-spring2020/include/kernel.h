...
/* #define	QUANTUM	30 */	/* time slice in milliseconds. 		*/ // Previous value for QUANTUM was 2.
				// Code changed by alankala, 2/15/20, to experiment with QUANTUM values for 3.2.

#define	QUANTUM	5		/* rerunning with value 5 for 3.2 b     */
